...
import UrBackupServer, {
  type MailSettingsVals,
...
// TODO: Extract only the relevant file backups fields
export type FileBackupsSettingsKey = ReturnType<
  UrBackupServer["clientSettingsList"]
>[number];
...
const FORM_MESSAGES: Record<FileBackupsSettingsKey, string> = {
...
const SETTINGS_ENUM = z.enum(["1", "2", "4"]);
const emptyOrPositive = (label: string) =>
  z.union([z.literal(""), z.coerce.number().check(z.gte(0, label))]);
...
const baseFileBackupsFields: BaseField<FileBackupsSettingsKey>[] = [
  {
