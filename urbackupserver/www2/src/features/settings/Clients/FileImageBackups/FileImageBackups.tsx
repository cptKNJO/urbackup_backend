...
import { CheckboxFieldDropdown, VALUE_TO_USE } from "./CheckboxFieldDropdown";
      ...
      <FormCard>
        <div className="flow">
          ...
          >
            {(validationMessages) => (
              <>
                {checkboxFieldInputs.map(({ field, labels }) => (
                  <CheckboxFieldDropdown
                    key={field}
                    name={field}
